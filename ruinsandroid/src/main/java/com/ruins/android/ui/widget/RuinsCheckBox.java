package com.ruins.android.ui.widget;
 ...
 * Modify  by Ruins.
 */
public class RuinsCheckBox extends View implements Checkable {
    ...
    public RuinsCheckBox(Context context) {
        this(context, null);
    }

    public RuinsCheckBox(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public RuinsCheckBox(Context context, AttributeSet attrs, int defStyle) {
